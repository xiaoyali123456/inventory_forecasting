...
ENV=prod
REGION=us-east-1
PIPELINE_UNIQUE_NAME=live-ads-cohort-density-classification
S3_PIPELINE_DIR=s3://adtech-ml-perf-ads-us-east-1-prod-v1/live_inventory_forecasting/pipeline_cohort_density
...
aws datapipeline put-pipeline-definition \
  ...
  --pipeline-definition "file://$LOCAL_DIR/deploy/pipeline.json" \
