...
ENV=prod
REGION=us-east-1
PIPELINE_UNIQUE_NAME=gec-ads-inventory-forecasting-offline
S3_PIPELINE_DIR=s3://adtech-ml-perf-ads-us-east-1-prod-v1/live_inventory_forecasting/pipeline_gec_inventory
